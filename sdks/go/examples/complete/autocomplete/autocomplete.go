...
import (
	...
	"github.com/sardine-ai/beam/sdks/go/pkg/beam/transforms/top"
	"github.com/sardine-ai/beam/sdks/go/pkg/beam/x/beamx"
	"github.com/sardine-ai/beam/sdks/go/pkg/beam/x/debug"
)

// TODO(herohde) 5/30/2017: fully implement https://github.com/sardine-ai/beam/blob/master/examples/java/src/main/java/org/apache/beam/examples/complete/AutoComplete.java

var (
	input = flag.String("input", os.ExpandEnv("$GOPATH/src/github.com/sardine-ai/beam/sdks/go/data/haiku/old_pond.txt"), "Files to read.")
